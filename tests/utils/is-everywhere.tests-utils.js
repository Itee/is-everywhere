...
const TestsUtils = {
    ...
    iterateOverDataMap: function ( func ) {
        ...
        return function _iterateOverDataMap () {
            ...
            for ( let mapKey in dataMap ) {
                ...
                for ( let setKey in dataSet ) {

                    func( mapKey, setKey, dataSet[ setKey ] )
    ...
    performTruthyTestOverDataMap: function ( func, truthyKey ) {

        return function _performTruthyTestOverDataMap () {
    ...
    performFalsyTestOverDataMap:  function ( func, falsyKey ) {

        return function _performFalsyTestOverDataMap () {
